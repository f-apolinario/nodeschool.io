...
/*
var example = 'this example exists';
example.replace('exists', 'is awesome');
console.log(example); //prints 'this example exists'
console.log(example.replace('exists', 'is awesome')); //prints 'this example is awesome'
*/
